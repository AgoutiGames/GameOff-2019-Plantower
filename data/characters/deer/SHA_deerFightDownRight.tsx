...
<tileset name="SHA_deerFightDownRight" tilewidth="256" tileheight="256" tilecount="30" columns="6">
 <image source="SHA_deerFightDownRight.png" width="1536" height="1280"/>
 <tile id="0" type="ACTOR_ANIMATION">
  <properties>
   <property name="ACTOR_NAME" value="SHA_Deer"/>
   <property name="ANIMATION_TYPE" value="CUSTOM1"/>
